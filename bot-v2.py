...
# -*- coding: utf-8 -*-
"""
ALF — Explorer + Cloud Eval + Stockfish blended UCI engine (+ tiny ML reranker)
...
class ALFEngine:
    ...
    def pick_move(self, movetime_ms: Optional[int], wtime: Optional[int], btime: Optional[int],
        ...
        # Failsafe: don't take a move that's much worse than SF best
        ...
        # Optional: log one line for debugging / datasets
        try:
